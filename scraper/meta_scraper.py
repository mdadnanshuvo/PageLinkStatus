...
def scrape_meta_content(page_content):
    ...
    meta_data = {
        ...
        "meta_description": meta_description.get('content') if meta_description else 'Not available',
        "og_title": og_title.get('content') if og_title else 'Not available',
        "og_description": og_description.get('content') if og_description else 'Not available'
    }
